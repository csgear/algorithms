...
public class SudokuSolver {
    public void solveSudoku(char[][] board) {
        ...
        int[] coordinate = getMaxPossibleCoordinate(
                board, rowState, columnState, boxState);

        recursivePlaceNumber2(
                board, rowState, columnState, boxState, coordinate[0], coordinate[1]);
    }

    private int[] getMaxPossibleCoordinate(
            char[][] board, boolean[][] rowState, boolean[][] columnState, boolean[][] boxState) {
        int x = -1, y = -1;
        int minCount = 9;
        for (int i = 0; i < 9; i++) {
            for (int j = 0; j < 9; j++) {
    ...
    private boolean recursivePlaceNumber2(
            char[][] board,
            boolean[][] rowState,
            boolean[][] columnState,
            boolean[][] boxState,
    ...
    private void placeNumber(
            ...
            boolean[][] rowState,
            boolean[][] columnState,
            boolean[][] boxState, int row, int column, int i) {
        rowState[row][i] = true;
    ...
    private void undoNumberPlacement(
            char[][] board,
            boolean[][] rowState,
            boolean[][] columnState,
            boolean[][] boxState,
            int row, int column, int i) {
